...
public class HelloRestController {
  ...
  String helloUser(@AuthenticationPrincipal(errorOnInvalidType = true) JwtAuthenticationToken principal) {
  ...
  String helloAdmin(@AuthenticationPrincipal(errorOnInvalidType = true) JwtAuthenticationToken principal) {
  return "Hello Mr. '" + principal.getTokenAttributes().get("given_name") + "' as Administrator";
